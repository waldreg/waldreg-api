...
@DataJpaTest
@ContextConfiguration(classes = {ScheduleRepositoryMapper.class, ScheduleRepositoryServiceProvider.class, JpaScheduleTestInitializer.class})
...
public class ScheduleRepositoryTest{
    ...
    public void READ_SPECIFIC_SCHEDULE_SUCCESS_TEST(){
        ...
        //then
        Assertions.assertAll(
                () -> Assertions.assertEquals(scheduleDtoList.get(0).getId(), result.getId()),
                () -> Assertions.assertEquals(scheduleDto.getScheduleTitle(), result.getScheduleTitle()),
                () -> Assertions.assertEquals(scheduleDto.getScheduleContent(), result.getScheduleContent()),
                () -> Assertions.assertEquals(scheduleDto.getStartedAt(), result.getStartedAt()),
                () -> Assertions.assertEquals(scheduleDto.getFinishAt(), result.getFinishAt()),
                () -> Assertions.assertEquals(scheduleDto.getRepeatDto().getCycle(), result.getRepeatDto().getCycle()),
                () -> Assertions.assertEquals(scheduleDto.getRepeatDto().getRepeatFinishAt(), result.getRepeatDto().getRepeatFinishAt())
        );
    ...
    public void DELETE_SCHEDULE_SUCCESS_TEST(){
        ...
        //then
        Assertions.assertFalse(() -> scheduleRepository.isExistScheduleId(scheduleDtoList.get(0).getId()));
