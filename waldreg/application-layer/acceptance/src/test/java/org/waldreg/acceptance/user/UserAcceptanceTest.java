...
public class UserAcceptanceTest{
    ...
    public void MODIFY_USER_3_VALUE_SUCCESS_TEST() throws Exception{
        ...
        ResultActions result=UserAcceptanceTestHelper.modifyUser(mvc,url,token, password,objectMapper.writeValueAsString(modifyUserCreateRequest));
    ...
    public void MODIFY_USER_1_VALUE_FAIL_INVALID_TOKEN_TEST() throws Exception{
        ...
        //when
        UserAcceptanceTestHelper.createUser(mvc, url,objectMapper.writeValueAsString(userCreateRequest));
        ResultActions result=UserAcceptanceTestHelper.modifyUser(mvc,url,invalidToken, password,objectMapper.writeValueAsString(modifyUserCreateRequest));
    ...
    public void MODIFY_USER_1_VALUE_FAIL_EMPTY_TOKEN_TEST() throws Exception{
        ...
        //when
        UserAcceptanceTestHelper.createUser(mvc, url,objectMapper.writeValueAsString(userCreateRequest));
        ResultActions result=UserAcceptanceTestHelper.modifyUser(mvc,url,null, password,objectMapper.writeValueAsString(modifyUserCreateRequest));
