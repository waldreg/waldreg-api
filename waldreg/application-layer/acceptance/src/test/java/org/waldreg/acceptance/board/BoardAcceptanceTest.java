...
class BoardAcceptanceTest{
    ...
    void INQUIRY_ALL_BOARD_SUCCESS_TEST() throws Exception{
        ...
        result.andExpectAll(
                ...
                MockMvcResultMatchers.jsonPath("$.boards.[2].title").value(title1),
                MockMvcResultMatchers.jsonPath("$.boards.[2].content").value(content1),
                MockMvcResultMatchers.jsonPath("$.boards.[2].category").value("cate1"),
                MockMvcResultMatchers.jsonPath("$.boards.[2].author.user_id").value("Admin"),
                MockMvcResultMatchers.jsonPath("$.boards.[2].author.name").value("Admin"),
                MockMvcResultMatchers.jsonPath("$.boards.[2].created_at").isNotEmpty(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].last_modified_at").isNotEmpty(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].views").value(0),
                MockMvcResultMatchers.jsonPath("$.boards.[2].comment_count").value(0),
                MockMvcResultMatchers.jsonPath("$.boards.[2].exist_file").value("false"),
                MockMvcResultMatchers.jsonPath("$.boards.[2].reactions.good").isNumber(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].reactions.bad").isNumber(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].reactions.check").isNumber(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].reactions.heart").isNumber(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].reactions.smile").isNumber(),
                MockMvcResultMatchers.jsonPath("$.boards.[2].reactions.sad").isNumber(),
                MockMvcResultMatchers.jsonPath("$.boards.[1].title").value(title2),
                MockMvcResultMatchers.jsonPath("$.boards.[0].title").value(title3)
        );
    }
    ...
    void INQUIRY_ALL_BOARD_SUCCESS_WITH_CATEGORY_TEST() throws Exception{
        ...
        result.andExpectAll(
                ...
                MockMvcResultMatchers.jsonPath("$.boards.[1].title").value(title1),
                MockMvcResultMatchers.jsonPath("$.boards.[1].content").value(content1),
